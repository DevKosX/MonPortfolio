...
// Informations spécifiques à l'expérience chez sty
$nomExperience = "Stage chez sty";
$imagePrincipale = "../../../public/images/sty_detail.jpg"; // Chemin vers une image détaillée du stage (À REMPLACER)
$descriptionLongue = "Stage de 8 semaines en développement web effectué au sein de l’entreprise sty. Durant ce stage, j'ai été intégré à l'équipe de développement et j'ai participé à [Décris tes tâches principales et les projets sur lesquels tu as travaillé]. J'ai pu mettre en pratique mes compétences en [Liste les compétences que tu as utilisées et développées]. (À REMPLACER avec une description détaillée de ton stage)";
$entreprise = "sty SAS";
$duree = "8 semaines";
